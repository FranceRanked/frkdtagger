...
public final class ProfilePopupRenderer {
    ...
    public static void renderWorld(/*? if >=26 {*//*LevelRenderContext*//*?} else {*/ WorldRenderContext /*?}*/ ctx) {
        ...
        boolean want = FrkdTagger.config().showPopup()
        ...
        float width = FrkdTagger.config().popupWidth() * (0.85F + 0.15F * ease);
        ...
        double ax = t.getX();
        double ay = t.getY() + t.getBbHeight() * 0.6 + FrkdTagger.config().popupOffset();
        double az = t.getZ();
